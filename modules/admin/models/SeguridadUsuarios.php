...
class SeguridadUsuarios extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    {
        return $this->hasOne(Direccion::className(), ['iddireccion' => 'id_direccion']);
    }
    ...
    {
        return $this->hasOne(\app\modules\siap\models\Persona::className(), ['cedula' => 'cedula']);
    }
    ...
    {
        return $this->hasMany(\app\modules\admin\models\UsuarioGrupo::className(), ['id_usuario' => 'id_usuario']);
    }
    /**
     * @return \yii\db\ActiveQuery
     */
