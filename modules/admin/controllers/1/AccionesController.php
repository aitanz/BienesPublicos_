...
use Yii;
use app\modules\siap\models\Acciones;
use app\modules\siap\models\AccionesSearch;
...
class AccionesController extends Controller
{
    ...
    {
        return Yii::getAlias(Yii::$app->getViewPath().'/Administracion/seguridad/acciones');
    }
