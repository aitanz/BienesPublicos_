...
use Yii;
use app\modules\siap\models\Controlador;
use app\modules\siap\models\ControladorSearch;
...
class ControladorController extends Controller
{
    ...
    {
        return Yii::getAlias(Yii::$app->getViewPath().'/Administracion/seguridad/controlador');
    }
