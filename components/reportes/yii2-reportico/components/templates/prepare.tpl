...
{/if}
                                <div style="display:none">   <b>{$T_SHOW}</b>
				<INPUT type="checkbox" style="display:none" name="user_criteria_entered" value="1" checked="1">
{if $BOOTSTRAP_STYLES}
{if $BOOTSTRAP_STYLES == "2" }
				<label style="display:inline-block" class="{$BOOTSTRAP_STYLE_CHECKBOX_BUTTON}"><INPUT type="checkbox" name="target_show_criteria" value="0" {$OUTPUT_SHOWCRITERIA}>{$T_SHOW_CRITERIA}</label>
...
{/if}
{else}
				<label class="{$BOOTSTRAP_STYLE_CHECKBOX_BUTTON}"><INPUT type="checkbox" name="target_show_criteria" value="0" {$OUTPUT_SHOWCRITERIA}>{$T_SHOW_CRITERIA}</label>
...
{/if}
{else}
				<INPUT type="checkbox" name="target_show_criteria" value="0" {$OUTPUT_SHOWCRITERIA}>{$T_SHOW_CRITERIA}
