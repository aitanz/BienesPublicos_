 ...
 * @property WebUsuarioGrupo[] $webUsuarioGrupos
 * @property WebGrupo[] $idGrupos
 * @property SeguridadUsuarioGrupo[] $seguridadUsuarioGrupos
 * @property SeguridadGrupo[] $idGrupos0
 */
class Usuario extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    {
        return $this->hasMany(\app\modules\siap\models\Ajustes::className(), ['id_usuario_crea' => 'idusuario']);
    }
    ...
    {
        return $this->hasOne(\app\modules\siap\models\Persona::className(), ['cedula' => 'persona']);
    }
    ...
    {
        return $this->hasMany(\app\modules\admin\models\UsuarioGrupo::className(), ['id_usuario' => 'idusuario']);
    }
    ...
    {
        return $this->hasMany(\app\modules\admin\models\Grupo::className(), ['id_grupo' => 'id_grupo'])->viaTable(\app\modules\admin\models\UsuarioGrupo::tableName(), ['id_usuario' => 'idusuario']);
    }
    ...
    {
        return strcmp(trim($this->passwd), md5(trim($password))) == 0;
    }
